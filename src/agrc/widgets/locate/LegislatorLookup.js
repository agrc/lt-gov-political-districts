...
dojo.declare('agrc.widgets.locate.LegislatorLookup', [agrc.widgets.locate._LegislatorMixin], {
	...
	getLegislatureForXY: function (geocodeResult) {
		...
		var legislatorDeferred = dojo.io.script.get({
			url: "http://mapserv.utah.gov/WSUT/GetFeatureAttributes.svc/legislatorLookup/layer(" + this._queryArgs.officialsLookup.layer + ")returnAttributes(" + this._queryArgs.officialsLookup.returnAttrs + ")utmX(" + geocodeResult.UTM_X + ")utmY(" + geocodeResult.UTM_Y + ")?dojo",
